...
import { Button, Carousel, Row,  Col, Flex, Input } from "antd";
  ...
  return (
    <Fragment>
            ...
            <Flex className="info">
              <Col className="info__item" >
                <div>
                  ...
                  <Title>Секретных транзакций</Title>
            ...
            <Flex className="info">
              <Col className="info__item">
                <div>
                  ...
                  <Title>И получите вознаграждение</Title>
                  <p>An improbable, overnight rise has established a new token as a blockchain gaming heavyweight.</p>
                  <Button>
                  <Link> Перейти и получить</Link>
                  </Button>
            ...
            <Flex className="info">
              <Col className="info__item">
                <div>
                  ...
                  <Title>Глобальные транзакции</Title>
                  <p>An improbable, overnight rise has established a new token as a blockchain gaming heavyweight.</p>
                  <Button>
                  <Link> Перейти и получить</Link>
                  </Button>
      ...
      <section className="section__main-2">
        <Container>
          <Title className="Partners-title" style={{ color: "#ffffff0e", fontSize: "200px", zIndex: "2" }}>ПАРТНЕРЫ</Title>
          <Flex className="Partners">

            <Col className="Partmers-info">
              <Title className="Partmers-info-title">Нас поддерживают</Title>
              <p style={{ fontSize: "18px", lineHeight: "170%" }}>Получите свободу, благодаря конфиденциальным,
                глобальным цифровым деньгам. Становитесь своим собственным банком с
            ...
            <div className="Partners-icon">
              <Flex className="wecar"><img src={wecar} alt="error" /></Flex>
              <Flex className="google"><img src={google} alt="error" /></Flex>
              <Flex className="yahoo"><img src={yahoo} alt="error" className="yahoo" /></Flex>
              <Flex className="w"><img src={w} alt="error" /></Flex>
              <Flex className="nasdaq"><img src={nasdaq} alt="error" /></Flex>
              <Flex className="grop1"><img src={grop1} alt="error" /></Flex>
              <Flex className="ods"><img src={ods} alt="error" /></Flex>
              <Flex className="yandex"><img src={yandex} alt="error" /></Flex>
              <Flex className="ambev"><img src={ambev} alt="error" /></Flex>
            </div>
          </Flex>
        </Container>
      </section>
        ...
        <Container className={"container__left2"}>
          <Flex className="Wallet">
            <Col span={11} className="Wallet">
              ...
              <p className="Wallet-text">BTCA предоставляет вам инструменты и ресурсы,
                чтобы вы всегда могли контролировать свои средства.</p>

              <Flex style={{ gap: "20px", paddingTop: "25px", paddingBottom: "25px" }}>
                <TfiAndroid style={{ color: "#636D85", transform: "scale(1.8)" }} />
                <TfiApple style={{ color: "#636D85", transform: "scale(1.8)" }} />
                <TfiLinux style={{ color: "#636D85", transform: "scale(1.8)" }} />
                <RiWindowsFill style={{ color: "#636D85", transform: "scale(1.8)" }} />
              </Flex>
              ...
              }}><TfiApple style={{ color: "#636D85", transform: "scale(1.8)", marginRight: "20px" }} />Скачать кошелек</Button>
            </Col>
      ...
      <section className="section__main-4">
        <Container>
          ...
          <p className="Steps__info-text">Независимо от того, являетесь ли вы разработчиком, мерчантом,
              конечным пользователем или покупателем окон, мы приветствуем вас в сообществе BTCA.</p>
            <Row className="Steps__Registration">
              <Col className="Registration__getting">
                <p className="Registration__getting-text">1 шаг</p>
                <Title className="Registration__getting-title" style={{color: "white"}}>Скачайте приложение</Title>
                <img src={Steps1} alt="error" className="Registration__getting-image"/>
                <Button className="Registration__getting-button"><Link>Перейти</Link></Button>
              </Col>
              <Col className="Registration__getting">
                <p className="Registration__getting-text">2 шаг</p>
                <Title className="Registration__getting-title" style={{color: "white"}}>Регестрируйтесь</Title>
                <img src={Steps2} alt="error" className="Registration__getting-image"/>
                <Button className="Registration__getting-button"><Link>Перейти</Link></Button>
              </Col>
              <Col className="Registration__getting">
                <p className="Registration__getting-text">3 шаг</p>
                <Title className="Registration__getting-title" style={{color: "white"}}>Пользуйтесь</Title>
                <img src={Steps3} alt="error" className="Registration__getting-image"/>
                <Button className="Registration__getting-button"><Link>Перейти</Link></Button>
              </Col>
            </Row>
          ...
          <Flex className="Block-area">
              <Col>
                <Title className="Block-area-title">Никогда не пропускайте обновления</Title>
                <p className="Block-area-text">Подпишитесь на информационный бюллетень и будьте
                  первым, кто получит новейшие оповещения, объявления и обновления о разработках BTCA.</p>
                <Flex>
                  <Input placeholder={"Ваш e-mail"} className="Footer__widgets-input"  style={{width: "600px", height: "65px"}}/>
                  <Button className="Footer__widgets-button" style={{width: "150px", height: "50px", marginLeft: "-160px" }}><Link>Подписаться</Link></Button>
                </Flex>
              </Col>
            </Flex>
        </Container>
